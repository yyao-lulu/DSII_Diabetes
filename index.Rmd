...
# create training set
diabetes_tidy = diabetes_tidy %>% mutate(readmitted = as.factor(readmitted))
set.seed(1)
train = sample(1:nrow(diabetes_tidy), 60000)

set.seed(1)
library(randomForest)
fit_rf = randomForest(readmitted~., data = diabetes_tidy, subset = train, mtry = 7, importance = TRUE)
importance(fit_rf)
```
